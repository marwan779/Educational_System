...
namespace Educational_System.Migrations
{
    ...
    [Migration("20240803200229_teacherID_Course_NUllable")]
    partial class teacherID_Course_NUllable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Educational_System.Models.Student", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2024, 8, 3, 23, 2, 29, 531, DateTimeKind.Local).AddTicks(1058));
            ...
            modelBuilder.Entity("Educational_System.Models.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("HireDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2024, 8, 3, 23, 2, 29, 531, DateTimeKind.Local).AddTicks(6736));
