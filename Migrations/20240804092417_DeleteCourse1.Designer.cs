...
namespace Educational_System.Migrations
{
    ...
    [Migration("20240804092417_DeleteCourse1")]
    partial class DeleteCourse1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Educational_System.Models.Student", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 12, 24, 15, 912, DateTimeKind.Local).AddTicks(7379));
            ...
            modelBuilder.Entity("Educational_System.Models.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("HireDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 12, 24, 15, 913, DateTimeKind.Local).AddTicks(3944));
