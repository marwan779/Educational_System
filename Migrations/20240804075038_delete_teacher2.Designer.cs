...
namespace Educational_System.Migrations
{
    ...
    [Migration("20240804075038_delete_teacher2")]
    partial class delete_teacher2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Educational_System.Models.Student", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 10, 50, 38, 179, DateTimeKind.Local).AddTicks(7199));
            ...
            modelBuilder.Entity("Educational_System.Models.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("HireDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 10, 50, 38, 180, DateTimeKind.Local).AddTicks(3561));
